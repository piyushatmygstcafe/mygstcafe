...
def calculate_monthly_salary(employee_data,total_working_days):
    ideal_check_in_time = datetime(1900, 1, 1, 10, 00)
    ideal_check_out_time = datetime(1900, 1, 1, 19, 00)
    ...
    for emp_id, data in employee_data.items():
        ...
        for record in attendance_records:
            ...
            if in_time is not None and out_time is not None:
                ...
                if total_working_hours >= 7.875 and total_working_hours <= 10.125:
                    overtime_salry = 0
                ...
                elif total_working_hours >= 5.625 and total_working_hours <7.875:
                    three_quarter_days += 1
                    actual_working_days += 1
                    total_salary += 0.75 * per_day_salary
                elif total_working_hours >= 3.375 and total_working_hours <5.625:
                    half_days += 1
                    actual_working_days += 1
                    total_salary += 0.5 * per_day_salary
                elif total_working_hours >= 1.125 and total_working_hours < 3.375:
                    quarter_days += 1
                    actual_working_days += 1
        ...
        data["salary_information"] = {
            ...
            "three_quarter_days": three_quarter_days,
